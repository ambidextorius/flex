...
void WaveNet::on_categoriesListWidget_currentItemChanged(QListWidgetItem* current, QListWidgetItem* previous)
{
...
void WaveNet::updateCategory(QString category)
{
    if(category == "")
	return;
...
static void NotifyMarketCategory(WaveNet *page, std::string category)
{
...
static void NotifyListingCancelled(WaveNet *page)
{
    
}

void WaveNet::subscribeToCoreSignals()
{
...
void WaveNet::unsubscribeFromCoreSignals()
{
...
void WaveNet::on_tableWidget_itemSelectionChanged()
{
...
void WaveNet::on_buyButton_clicked()
{
...
void WaveNet::on_viewDetailsButton_clicked()
{
    QItemSelectionModel* selectionModel = ui->tableWidget->selectionModel();
    QModelIndexList selected = selectionModel->selectedRows();
    if(selected.count() == 0)
...
void WaveNet::on_copyAddressButton_clicked()
{
    QItemSelectionModel* selectionModel = ui->tableWidget->selectionModel();
    QModelIndexList selected = selectionModel->selectedRows();
    if(selected.count() == 0)
