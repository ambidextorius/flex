...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeflexcoinamount=<n> " + _("Keep N FlexCoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeFlexCoinAmount = GetArg("-anonymizeflexcoinamount", 0);
    if(nAnonymizeFlexCoinAmount > 999999) nAnonymizeFlexCoinAmount = 999999;
    if(nAnonymizeFlexCoinAmount < 2) nAnonymizeFlexCoinAmount = 2;
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeFlexCoinAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    LogPrintf("Anonymize FlexCoin Amount %d\n", nAnonymizeFlexCoinAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1FCX+1000 == (.1FCX+100)*10
       10FCX+10000 == (1FCX+1000)*10
    */
